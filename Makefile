...
SOURCES = \
	__init__.py \
	freehand_reshape.py freehand_reshape_dialog.py

PLUGINNAME = freehand_reshape

PY_FILES = \
	__init__.py \
	freehand_reshape.py freehand_reshape_dialog.py

UI_FILES = freehand_reshape_dialog_base.ui
...
QGISDIR=C:\Users\oguzhan\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
